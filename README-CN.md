...
#### 匹配所有（基础运营商 + 虚拟运营商）
[`^(?:\+?86)?1(?:3\d{3}|5[^4\D]\d{2}|8\d{3}|7[^29\D](?(?<=4)(?:0[0-5]|9\d)|\d{2})|9[189]\d{2}|6[67]\d{2})\d{6}$`][匹配所有（基础运营商 + 虚拟运营商）]

#### 匹配所有（基础运营商 + 虚拟运营商 + 海事卫星通信 + 应急通信）
[`^(?:\+?86)?1(?:3\d{3}|5[^4\D]\d{2}|8\d{3}|7[^29\D](?(?<=4)(?:0\d|1[0-2]|9\d)|\d{2})|9[189]\d{2}|6[67]\d{2})\d{6}$`][匹配所有（基础运营商 + 虚拟运营商 + 海事卫星通信 + 应急通信）]

#### 匹配基础运营商
[`^(?:\+?86)?1(?:3\d{3}|5[^4\D]\d{2}|8\d{3}|7[^0129\D](?(?<=4)(?:0[0-5]|9\d)|\d{2})|9[189]\d{2}|66\d{2})\d{6}$`][匹配基础运营商]
...
[匹配所有（基础运营商 + 虚拟运营商）]: https://www.debuggex.com/r/hRJMNKTKON30Y_d_

[匹配所有（基础运营商 + 虚拟运营商 + 海事卫星通信 + 应急通信）]: https://www.debuggex.com/r/LqA8Pct_4vdywTis

[匹配基础运营商]: https://www.debuggex.com/r/4SscQaBESV0o00-k
