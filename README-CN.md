...
### 匹配所有号码（手机卡 + 数据卡 + 上网卡）
[`^(?:\+?86)?1(?:3\d{3}|4[57]\d{2}|5[^4\D]\d{2}|8\d{3}|7(?:[0-35-9]\d{2}|4(?:0\d|1[0-2]|9\d))|9[0-35-9]\d{2}|6[2567]\d{2}|4(?:(?:10|4[01])\d{3}|[68]\d{4}|[579]\d{2}))\d{6}$`][匹配所有号码（手机卡 + 数据卡 + 上网卡）]

### 匹配所有支持短信功能的号码（手机卡 + 上网卡）
[`^(?:\+?86)?1(?:3\d{3}|4[57]\d{2}|5[^4\D]\d{2}|8\d{3}|7(?:[0-35-9]\d{2}|4(?:0\d|1[0-2]|9\d))|9[0-35-9]\d{2}|6[2567]\d{2}|4[579]\d{2})\d{6}$`][匹配所有支持短信功能的号码（手机卡 + 上网卡）]

### 手机卡

#### 匹配所有
[`^(?:\+?86)?1(?:3\d{3}|4[57]\d{2}|5[^4\D]\d{2}|8\d{3}|7(?:[235-8]\d{2}|4(?:0\d|1[0-2]|9\d))|9[0-35-9]\d{2}|66\d{2})\d{6}$`][匹配基础运营商]

#### 匹配中国移动
[`^(?:\+?86)?1(?:3(?:4[^9\D]|[5-9]\d)|47\d|5[^3-6\D]\d|7[28]\d|8[23478]\d|9[578]\d)\d{7}$`][匹配基础运营商中国移动]

#### 匹配中国联通
[`^(?:\+?86)?1(?:3[0-2]|45|[578][56]|66|96)\d{8}$`][匹配基础运营商中国联通]
